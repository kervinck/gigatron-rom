...
def code8():
	...
	LDWI('words');ADDW(R22);DEEK();STW(R9);
	_MOVW(R9,[SP,4]);
	LDWI(v('words')+2);ADDW(R22);DEEK();STW(R10);
	_MOVW(R10,[SP,6]);
	LDWI(v('words')+4);ADDW(R22);DEEK();STW(R11);
	_MOVW(R11,[SP,8]);
	LDWI(v('words')+6);ADDW(R22);STW(R12);
	_MOVW(R12,[SP,10]);
	CALLI('printf');
	label('.38');
	LDI(1);ADDW(R7);STW(R7);
