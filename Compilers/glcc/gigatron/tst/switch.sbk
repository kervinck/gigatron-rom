...
def code1():
	...
	LDW(R8);_CMPIS(102);_BGT('.25');
	label('.24');
	LDW(R8);XORI(98);_BEQ('.18');
	_BRA('.16');
	label('.25');
	LDW(R8);XORI(110);_BEQ('.20');
	LDW(R8);_CMPIS(110);_BLT('.16');
	label('.26');
...
def code2():
	...
	label('.29');
	LDW(R7);STW(R5);
	LDW(R7);_CMPIS(1);_BLT('.33');
	LDW(R7);_CMPIS(20);_BGT('.33');
	LDWI(v('.45')-2);STW(R22);
...
def code4():
	...
	LDWI(v('.69')-2002);STW(R22);
	LDW(R7);LSLW();ADDW(R22);DEEK();CALL(vAC);
	label('.67');
	LDW(R7);_CMPIS(1);_BLT('.54');
	LDW(R7);_CMPIS(8);_BGT('.54');
	LDWI(v('.71')-2);STW(R22);
	LDW(R7);LSLW();ADDW(R22);DEEK();CALL(vAC);
	label('.68');
	LDWI(3001);_CMPWS(R7);_BGT('.54');
	LDWI(3004);_CMPWS(R7);_BLT('.54');
	LDWI(v('.73')-6002);STW(R22);
	LDW(R7);LSLW();ADDW(R22);DEEK();CALL(vAC);
	label('.56');
	LDWI('.57');STW(R8);
	_MOVW(R8,[SP,2]);
...
def code8():
	...
	label('.77');
	LDWI(264);STW(R22);
	LDW(R7);XORW(R22);_BEQ('.89');
	LDW(R7);_CMPWS(R22);_BGT('.97');
	label('.96');
	LDW(R7);XORI(120);_BEQ('.87');
	LDW(R7);_CMPIS(120);_BGT('.99');
	label('.98');
	LDW(R7);XORI(8);_BEQ('.86');
	LDW(R7);_CMPIS(8);_BLT('.81');
	label('.100');
	LDW(R7);XORI(16);_BEQ('.85');
	_BRA('.81');
	label('.99');
	LDW(R7);XORI(128);_BEQ('.83');
	LDW(R7);_CMPIS(128);_BLT('.81');
	label('.101');
	LDW(R7);XORI(248);_BEQ('.90');
	_BRA('.81');
	label('.97');
	LDWI(288);STW(R22);
	LDW(R7);XORW(R22);_BEQ('.94');
	LDW(R7);_CMPWS(R22);_BGT('.103');
	label('.102');
	LDWI(272);STW(R22);
	LDW(R7);XORW(R22);_BEQ('.91');
	LDW(R7);_CMPWS(R22);_BLT('.81');
	label('.104');
	LDWI(280);XORW(R7);_BEQ('.88');
	_BRA('.81');
	label('.103');
	LDWI(304);STW(R22);
	LDW(R7);XORW(R22);_BEQ('.92');
	LDW(R7);_CMPWS(R22);_BGT('.106');
	label('.105');
...
def code9():
	...
	_MOVL('.120',L21);
	_MOVL(L5,LAC);LDI(L21);_LCMPX();_BEQ('.115');
	_MOVL(L5,LAC);LDI(L21);_LCMPS();_BGT('.119');
	label('.118');
	_MOVL(L5,LAC);LDWI('.121');_LCMPX();_BEQ('.113');
	_MOVL(L5,LAC);LDWI('.122');_LCMPX();_BEQ('.113');
	_MOVL(L5,LAC);LDWI('.14');_LCMPX();_BEQ('.113');
	_BRA('.109');
	label('.119');
...
def code10():
	...
	label('.125');
	LDWI(-32768);STW(R22);
	LDW(R7);_CMPWS(R22);_BLT('.129');
	LDWI(-32764);_CMPWS(R7);_BLT('.129');
	LDW(R22);LSLW();STW(R22);
	LDWI('.142');STW(R21);
	LDW(R7);LSLW();SUBW(R22);ADDW(R21);DEEK();CALL(vAC);
	label('.131');
	LDWI('.132');STW(R8);
	_MOVW(R8,[SP,2]);
	CALLI('printf');
...
code=[
	...
	('DATA', '.7', code41, 0, 1),
	('DATA', '.6', code42, 0, 1) ]
module(code=code, name='tst/switch.c', cpu=5);
