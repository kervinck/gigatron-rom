...
ld(-22/2)                       #19
jmp(Y,lo('v6502_ENTER'));       C('Transfer control in the same time slice')#20
adda([vTicks])                  #21
...
bra('v6502_modeABS'); bra('v6502_modeABS'); bra('v6502_modeABS'); bra('v6502_modeILL') # $10 xxx011xx
bra('v6502_modeREL'); bra('v6502_modeIZY'); bra('v6502_modeIMM'); bra('v6502_modeILL') # $14 xxx100xx
...
#     $6C JMP ($DDDD)   but gets $DDDD     Handle in v6502_JMP2
...
nop()                           #34
label('.abs35')
anda(0x80,X)                    #35 Move the carry to bit 0 (0 or +1)
ld([X])                         #36
st([v6502_ADH])                 #37
...
st([v6502_ADL])                 #36
st([Y,Xpp])                     #37 Wrap-around is correct
ld([Y,X])                       #38
st([v6502_ADH])                 #39
...
nop()                           #46
label('.izy47')
anda(0x80,X)                    #47 Move the carry to bit 0 (0 or +1)
ld([X])                         #48
adda([v6502_ADH])               #49
st([v6502_ADH])                 #50
ld([v6502_ADL],X)               #51
...
label('v6502_ADC')
ld([v6502_ADH],Y)               #9,15
ld([v6502_P]);                  C('Carry in')#10
anda(1)                         #11
adda([v6502_A]);                C('Sum')#12
beq('.adc2')                    #13 Danger zone for dropping a carry
adda([Y,X])                     #14
st([v6502_Q]);                  C('Update Q')#15 Don't overwrite left-hand side (A) yet
xora([v6502_A]);                C('Overflow flag')#16 (Q^A) & (B^Q) & 128
st([v6502_A])                   #17
ld([Y,X])                       #18
xora([v6502_Q])                 #19
anda([v6502_A])                 #20
anda(128)                       #21
st([v6502_Tmp])                 #22
ld([v6502_Q]);                  C('Update A')#23
st([v6502_A])                   #24
bmi('.adc0');                   C('Carry flag')#25
suba([Y,X])                     #26
bra('.adc1')                    #27
ora([Y,X])                      #28
label('.adc0')
...
jmp(Y,lo('v6502_next'))         #36
ld(-38/2)                       #37
# Cin=1, A=$FF, B=$DD --> Result=$DD, Cout=1, V=0
# Cin=0, A=$00, B=$DD --> Result=$DD, Cout=0, V=0
label('.adc2')
st([v6502_A]);                  C('Special case')#15
ld([v6502_P])                   #16
anda(0x7f);                     C('V=0, keep C')#17
st([v6502_P])                   #18
...
st([v6502_M])                   #12 Park modified operand for v6502_ADC
ld(v6502_M&255)                 #13 Create pointer value
st([v6502_ADL])                 #14
ld(v6502_M>>8)                  #15
st([v6502_ADH])                 #16
...
label('v6502_JMP1')
ld(hi('v6502_jmp1'),Y);         C('JMP $DDDD')#9
jmp(Y,lo('v6502_jmp1'))         #10
#nop()                          #11 Overlap
label('v6502_JMP2')
...
jmp(Y,lo('v6502_inc'))          #10
#nop()                          #11 Overlap
label('v6502_LDA')
ld(hi('v6502_lda'),Y)           #9,11
jmp(Y,lo('v6502_lda'))          #10
#nop()                          #11 Overlap
label('v6502_LDX')
ld(hi('v6502_ldx'),Y)           #9,11
jmp(Y,lo('v6502_ldx'))          #10
#nop()                          #11 Overlap
label('v6502_LDY')
ld(hi('v6502_ldy'),Y)           #9,11
jmp(Y,lo('v6502_ldy'))          #10
#nop()                          #11 Overlap
label('v6502_STA')
ld(hi('v6502_sta'),Y)           #9,11
jmp(Y,lo('v6502_sta'))          #10
#nop()                          #11 Overlap
label('v6502_STX')
ld(hi('v6502_stx'),Y)           #9,11
jmp(Y,lo('v6502_stx'))          #10
#nop()                          #11 Overlap
label('v6502_STY')
ld(hi('v6502_sty'),Y)           #9,11
jmp(Y,lo('v6502_sty'))          #10
#nop()                          #11 Overlap
label('v6502_TAX')
ld(hi('v6502_tax'),Y)           #9,11
jmp(Y,lo('v6502_tax'))          #10
#nop()                          #11 Overlap
label('v6502_TAY')
ld(hi('v6502_tay'),Y)           #9,11
jmp(Y,lo('v6502_tay'))          #10
#nop()                          #11 Overlap
label('v6502_TXA')
ld(hi('v6502_txa'),Y)           #9,11
jmp(Y,lo('v6502_txa'))          #10
#nop()                          #11 Overlap
label('v6502_TYA')
ld(hi('v6502_tya'),Y)           #9,11
jmp(Y,lo('v6502_tya'))          #10
#nop()                          #11 Overlap
label('v6502_CLV')
