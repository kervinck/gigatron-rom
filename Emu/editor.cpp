...
namespace Editor
{
    ...
    void handleKeyDown(SDL_Keycode keyCode)
    {
        switch(keyCode)
        {
            ...
            case SDLK_DOWN:  _cursorY = (++_cursorY >= HEX_CHARS_Y) ? 0  : _cursorY;   _memoryDigit = 0; _addressDigit = 0; break;
            case SDLK_UP:    _cursorY = (--_cursorY < -1) ? HEX_CHARS_Y-1 : _cursorY;  _memoryDigit = 0; _addressDigit = 0; break;
    ...
    void updateHexEditor(SDL_Keycode keyCode)
    {
        int range = 0;
    ...
    void handleKeyUp(SDL_Keycode keyCode)
    {
        switch(keyCode)
        {
            ...
            case SDLK_RETURN: (_loadFile == false) ? _hexEdit = !_hexEdit : Loader::setStartUploading(true); break;
        }

        if(_hexEdit == true) updateHexEditor(keyCode);
    }
