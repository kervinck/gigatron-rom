std::vector<std::string> _defaultKeys =
{
    ...
    "Hex_Mode     = F9       ; switches to Hex mode from any other mode             ",
    "                                                                               ",
    ...
    "PS2_KB       = F10      ; toggles PS2 Keyboard emulation on and off            ",
    "                                                                               ",
    ...
    "Giga         = F11      ; toggles Gigatron input between emulator and hardware ",
    "Giga_PS2     = F12      ; toggles PS2 keyboard between emulator and hardware   ",
    "                                                                               ",
    "[Debugger]              ; case sensitive                                       ",
    "Debug        = F6       ; toggles debugging mode, can be used to pause         ",
    "Step         = F7       ; single steps debugger based on a watched variable    ",
