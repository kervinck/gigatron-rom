std::vector<std::string> _defaultKeys =
{
    ...
    "; Text cursor is controlled via the mouse                                       ",
    "                                                                                ",
    ...
    "Browse       = CTRL+B    ; toggles between hex mode and browser mode            ", 
    "RomType      = CTRL+R    ; toggles between hex mode and ROM types               ",
    "Reset        = CTRL+F1   ; emulator reset                                       ",
    "Disassembler = CTRL+D    ; disassemble contents of monitor window               ",
