...
namespace Functions
{
    ...
    // string functions
    Expression::Numeric CHR$(Expression::Numeric& numeric,    const std::string& codeLineText, int codeLineIndex);
    Expression::Numeric STR$(Expression::Numeric& numeric,    const std::string& codeLineText, int codeLineIndex);
    Expression::Numeric TIME$(Expression::Numeric& numeric,   const std::string& codeLineText, int codeLineIndex);
    Expression::Numeric HEX$(Expression::Numeric& numeric,    const std::string& codeLineText, int codeLineIndex);
    Expression::Numeric LEFT$(Expression::Numeric& numeric,   const std::string& codeLineText, int codeLineIndex);
    Expression::Numeric RIGHT$(Expression::Numeric& numeric,  const std::string& codeLineText, int codeLineIndex);
    Expression::Numeric MID$(Expression::Numeric& numeric,    const std::string& codeLineText, int codeLineIndex);
    Expression::Numeric LOWER$(Expression::Numeric& numeric,  const std::string& codeLineText, int codeLineIndex);
    Expression::Numeric UPPER$(Expression::Numeric& numeric,  const std::string& codeLineText, int codeLineIndex);
    Expression::Numeric STRCAT$(Expression::Numeric& numeric, const std::string& codeLineText, int codeLineIndex);
}
