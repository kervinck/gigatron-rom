...
const byte Invader_gt1[]    PROGMEM = {
  #include "Invader.h"
};
const byte PucMon_gt1[]  PROGMEM = {
  #include "PucMon_ROMv5a.h"
};
const byte puzzles_gt1[]    PROGMEM = {
  #include "puzzles.h"
};
const byte Parallax_gt1[]    PROGMEM = {
  #include "Parallax.h"
};
const byte Poker_gt1[]    PROGMEM = {
...
#endif
#if maxStorage >= 30000
  { Parallax_gt1,    "Parallax Demo"        }, // 1607 bytes
...
const byte ledIdle = A1;
const byte ledBusy = A0;
...
/*
 *  Loop runs repeateinMode(ledPin, OUTPUT);dly
 */
void loop()
{
  // C U S T O M
