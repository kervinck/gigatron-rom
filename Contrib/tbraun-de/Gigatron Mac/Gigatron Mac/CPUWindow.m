...
-(void) refresh {
        ...
        switch(RAM[address]) {
            ...
            case 0x35:
                switch(RAM[address+1]) {
                    ...
                    case 0x54: [ramString appendFormat:@"BGE  0x%02x", RAM[address+2]]; address+=3; break;
                    case 0x56: [ramString appendFormat:@"BLE  0x%02x", RAM[address+2]]; address+=3; break;
                    case 0x73: [ramString appendFormat:@"BNE  0x%02x", RAM[address+2]]; address+=3; break;
            ...
            case 0xcf: [ramString appendFormat:@"CALL 0x%02x", RAM[address+1]]; address+=3; break;
            ...
            case 0xb4: [ramString appendFormat:@"SYS  %02x", RAM[address+1]]; address+=1; break;
    ...
    while(address <= romPage+255) {
        ...
        switch(ROM[address].instruction) {
            case 0x00: [romString appendFormat:@".LD   0x%02x", ROM[address].operand]; address++; break;
            case 0x02: [romString appendFormat:@".NOP  0x%02x", ROM[address].operand]; address++; break;
            case 0x20: [romString appendFormat:@".ANDA 0x%02x", ROM[address].operand]; address++; break;
            case 0x40: [romString appendFormat:@".ORA  0x%02x", ROM[address].operand]; address++; break;
            case 0x60: [romString appendFormat:@".XORA 0x%02x", ROM[address].operand]; address++; break;
            case 0x80: [romString appendFormat:@".ADDA 0x%02x", ROM[address].operand]; address++; break;
            case 0xA0: [romString appendFormat:@".SUBA 0x%02x", ROM[address].operand]; address++; break;
            case 0xC0: [romString appendFormat:@".ST   0x%02x", ROM[address].operand]; address++; break;
            case 0xE0: [romString appendFormat:@".JMP  0x%02x", ROM[address].operand]; address++; break;
            case 0xE4: [romString appendFormat:@".BGT  0x%02x", ROM[address].operand]; address++; break;
            case 0xE8: [romString appendFormat:@".BLT  0x%02x", ROM[address].operand]; address++; break;
            case 0xEC: [romString appendFormat:@".BNE  0x%02x", ROM[address].operand]; address++; break;
            case 0xF0: [romString appendFormat:@".BEQ  0x%02x", ROM[address].operand]; address++; break;
            case 0xF4: [romString appendFormat:@".BGE  0x%02x", ROM[address].operand]; address++; break;
            case 0xF8: [romString appendFormat:@".BLE  0x%02x", ROM[address].operand]; address++; break;
            case 0xFC: [romString appendFormat:@".BRA  0x%02x", ROM[address].operand]; address++; break;
            default: [romString appendFormat:@".[%02x] 0x%02x", ROM[address].instruction, ROM[address].operand]; address++; break;
        }
        [romString appendString:@"\n"];
    }
